...
export default function FondoImageUploader() {
  const { setValue, getValues } = useFormContext<FondoInput>();
  ...
  return (
    <div className="space-y-3">
      <UploadDropzone
        ...
        onUploadError={(err) => { console.error('Upload error:', err.message); }}
        appearance={{
        ...
        content={{
          button: 'Selecciona imagen del fondo',
