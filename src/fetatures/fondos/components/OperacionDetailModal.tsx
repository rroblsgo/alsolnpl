...
import { updateOperacionStatusAction } from '../actions/excel-actions';
import type { OperacionStatus } from '@/src/db/schema/operaciones';
...
// Grupos para organizar la información en secciones
const SECTIONS: { title: string; fields: string[] }[] = [
  { title: 'Identificación',   fields: ['expedienteId','prestamoId','nplReo','assetManager','oficinaResponsable'] },
  ...
  { title: 'Ubicación',        fields: ['direccionCompleta','municipio','provincia','codPostal'] },
...
export default function OperacionDetailModal({ operacion, onClose, onUpdated }: Props) {
  ...
  const handleSave = async () => {
    ...
    onUpdated({ ...operacion, statusTratamiento: status as SelectOperacion['statusTratamiento'], fechaTratamiento: fecha });
    onClose();
  };
