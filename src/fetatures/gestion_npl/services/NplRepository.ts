...
const nplSelectFields = {
  ...
  enrichmentId: npl.enrichmentId,
  enrichmentOperacionId: npl.enrichmentOperacionId,
  // A
  ...
  superficieUtil: npl.superficieUtil,
  ...
  valorRefCatastral: npl.valorRefCatastral,
  valorCatastral: npl.valorCatastral,
  ...
  tasacionActual: npl.tasacionActual,
