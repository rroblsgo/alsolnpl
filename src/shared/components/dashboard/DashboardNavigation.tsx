...
const navigation = [
  ...
  { name: 'Operaciones',     href: '/dashboard/operaciones',  icon: TableCellsIcon, allRoles: true },
];
      ...
      <ul role="list" className="flex flex-1 flex-col gap-y-7">
        ...
        <li className="mt-auto pb-4">
          ...
          <ul role="list" className="-mx-2 space-y-1">
            ...
            {isAdmin && (
              <li>
                <Link href={'/dashboard/users/create' as Route}
                  className={classNames(
          ...
          <div className="mt-4 px-2">
            <p className="text-[11px] text-gray-400 dark:text-gray-600">AlsolNPL · Alsol Inmobiliaria</p>
          </div>
        </li>
